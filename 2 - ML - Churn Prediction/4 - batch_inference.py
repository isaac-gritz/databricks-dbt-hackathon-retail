...
model_name = "dbx_dbt_churn_prediction_decision_tree"
...
model_name = "dbx_dbt_churn_prediction_decision_tree"
input_table_name = "dbx_dbt_retail.churn_prediction"
output_table_path = "/FileStore/batch-inference/dbx_dbt_churn_prediction_decision_tree"
...
# MAGIC ```python
# MAGIC output_table = "" # Example: "ml.batch-inference.dbx_dbt_churn_prediction_decision_tree"
...
output_df = output_df[['customer_id',
 'churn',
 'prediction',
 'order_total',
 'avg_order_total',
...
output_df.write.format("delta").saveAsTable("hive_metastore.dbx_dbt_retail.churn_prediction_scored")
